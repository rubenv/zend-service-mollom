 ...
 * @version    $Id: TestHelper.php 12933 2008-11-28 11:51:24Z alexander $
 */
...
if (!isset($_ENV['ZF_LIB'])) {
	die("Set the ZF_LIB environment variable to the path of your Zend Framework library\n");
}
...
$zfMollomLibrary = "$zfRoot/library";
$zfCoreLibrary = $_ENV['ZF_LIB'];
 ...
 */
unset($zfRoot, $zfCoreLibrary, $zfMollomLibrary, $zfCoreTests, $path);
